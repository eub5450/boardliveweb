...
<head>
  ...
  <title>BD Live Agency Request From</title>
...
<!-- Form Name -->
  <legend><center><h2><b>BD Agency Request Form</b></h2></center></legend><br>
...
<div class="form-group">
  <label class="col-md-4 control-label" >Selfie With NID <span style=" color: red; font-weight: 900; ">*</span></label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="selfie" placeholder="Password" class="form-control agency-image-input" onchange="readURL1(this);" required="" type="file" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp">
...
<div class="form-group">
  <label class="col-md-4 control-label" >Nid <span style=" color: red; font-weight: 900; ">*</span></label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="nid" placeholder="Password" class="form-control agency-image-input" onchange="readURL2(this);" required="" type="file" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp">
...
<div class="form-group">
  <label class="col-md-4 control-label" >Your Pic <span style=" color: red; font-weight: 900; ">*</span></label> 
    ...
    <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input name="photo_id" placeholder="Password" class="form-control agency-image-input" onchange="readURL3(this);" required="" type="file" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp">
   <img src="" id="three" class="col-sm-4 col-form-label text-left"  >

    </div>
    <small class="text-danger">Only JPG, JPEG, PNG or WEBP. Max 2MB.</small>
  </div>
</div>
<div class="form-group"> 
