...
<div class="body-content">
					...
					<div class="card">
							...
							<div class="box-body">
								...
								<address class="mb-0 text-center">
									<img src="{{URL::to($user->profile)}}" style="width: 146px;">
		...
		<div class="col-xl-6 col-sm-6 py-2">
               	<div class="card ">
                    ...
                    <img style=" width: 80%; " src="{{URL::to($data->image)}}">
                </div>
            </div>
		</div>
		<div class="col-xl-6 col-sm-6 py-2">
               	<div class="card ">
			 		<div class="card-body">
                    <img style=" width: 80%; " src="{{URL::to($data->photo_id)}}">
                </div>
            </div>
		</div>
		<div class="col-xl-6 col-sm-6 py-2">
               	<div class="card ">
			 		<div class="card-body">
                    <img style=" width: 80%; " src="{{URL::to($data->selfie)}}">
                </div>
            </div>
		</div>
	</div>
