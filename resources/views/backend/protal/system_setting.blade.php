    ...
    <div class="system-setting-shell">
        ...
        <form action="{{ URL::to('setting/system-setting-update') }}" method="post" class="system-setting-form">
            ...
            <section class="setting-panel">
                <div class="setting-panel-head">
                    <div>
                        <h2 class="setting-panel-title">Recall Setting</h2>
                        <p class="setting-panel-text">
                            Controls how user balance recall is split between the selected portal and the company user in both admin and country-admin recall panels.
                        </p>
                    </div>
                    <span class="setting-panel-badge">Admin + Country Admin</span>
                </div>

                <div class="setting-grid">
                    <div class="setting-field">
                        <div class="setting-label-row">
                            <label for="recall_portal_percentage" class="setting-label">Portal %</label>
                        </div>
                        <input type="number" name="recall_portal_percentage" id="recall_portal_percentage" class="setting-input" min="0" max="100" required title="Percent of recalled amount that goes to the selected portal." value="{{ old('recall_portal_percentage', $recallPortalPercentage) }}">
                        <p class="setting-help">Percent of recalled amount credited into portal recharge.</p>
                    </div>

                    <div class="setting-field">
                        <div class="setting-label-row">
                            <label for="recall_company_percentage" class="setting-label">Company %</label>
                        </div>
                        <input type="number" name="recall_company_percentage" id="recall_company_percentage" class="setting-input" min="0" max="100" required title="Percent of recalled amount that goes to the company user balance." value="{{ old('recall_company_percentage', $recallCompanyPercentage) }}">
                        <p class="setting-help">Percent of recalled amount credited into the company user balance.</p>
                    </div>

                    <div class="setting-field setting-field-full">
                        <div class="setting-label-row">
                            <label for="recall_company_user_id" class="setting-label">Company User ID</label>
                        </div>
                        <input type="number" name="recall_company_user_id" id="recall_company_user_id" class="setting-input" min="1" required title="User ID that receives the company part of recalled balance." value="{{ old('recall_company_user_id', $recallCompanyUserId) }}">
                        <p class="setting-help">Portal % and Company % must total exactly 100. Company share is added directly to this user balance.</p>
                    </div>
                </div>
            </section>
