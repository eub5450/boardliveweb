        ...
        <div class="card-body">
                ...
                <form action="{{ route('country.author.agency-store') }}" method="post" enctype="multipart/form-data" class="form-inline">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="file" name="photo_id" class="form-control col-sm-8 agency-image-input" id="logo" placeholder="Logo" onchange="readURL2(this);" value="" required="" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp">
                       <img src="http://#/logo.png" id="two" class="col-sm-4 col-form-label text-left"  >
                        <small class="text-danger d-block">Only JPG, JPEG, PNG or WEBP. Max 2MB.</small>
                        <span class="text-danger"></span>
                    </div> 
                    <div class="form-group col-md-6 mb-3">
                        <label for="logo" class="col-sm-4 col-form-label text-right">Selfie</label>
                        <input type="file" name="selfie" class="form-control col-sm-8 agency-image-input" id="logo" placeholder="Logo" onchange="readURL3(this);" value="" required="" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp">.
