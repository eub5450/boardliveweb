                ...
                <div class="table-responsive">
                  <table class="table display table-bordered table-striped table-hover basic">
                    <thead>
                      <tr>
                       ...
                       <th>Total Recived</th>
                       <th>Total Sand</th>
                       {{-- Country panel recall system hidden. Uncomment this column to restore.
                         <th>Total Recall</th>
                       --}}
                       <th>Balance</th>
                     </tr>
                   ...
                   <tbody>
                    ...
                    {{-- Country panel recall system hidden. Keep calculation commented for quick restore.
                    ...
                    <tr>
                      ...
                      <td>  {{$total_recived}}  </td>
                      <td>  {{$total_sand}}  </td>
                      {{-- Country panel recall system hidden. Uncomment this cell to restore.
                      <td>  {{$total_recall}}  </td>
                      --}}
                  ...
                  <tfoot>
                    <tr>
                     ...
                     <th>Total Recived</th>
                     <th>Total Sand</th>
                     {{-- Country panel recall system hidden. Uncomment this footer column to restore.
                     <th>Total Recall</th>
                     --}}
                     <th>Balance</>
                   </tr>
