...
<head>
    <meta charset="UTF-8">
    <title>BD Live Supper Agency Salary Sheet For {{$master_agency->name}} --{{$master_agency->code}}</title>
<style type="text/css">
...
<body>
    ...
    <div class="container">
      <h1>BD Live Supper Agency Salary Sheet For {{$master_agency->name}} --{{$master_agency->code}} --{{$start_date}} to {{$end_date}}</h1>
