...
.profile-compact .body-content{padding-top:10px;padding-bottom:10px}
.profile-compact .card{margin-bottom:12px}
.profile-compact .card-body{padding:12px}
.profile-compact .card-header{padding:14px 15px}
.profile-compact .rating-block{margin-bottom:10px}
.profile-compact table{margin-bottom:10px}
.profile-compact .table th,
.profile-compact .table td{padding:7px 9px;vertical-align:middle;line-height:1.25}
.profile-compact .profile-nowrap{white-space:nowrap}
.profile-compact .profile-action-cell{white-space:nowrap}
.profile-compact .profile-table-card{overflow-x:auto}
</style>
...
<div class="body-content">
	<div class="row">
   @php
      $legacyProfileContact = \App\Models\AdminParmisiton::allowed(
         Auth::id(),
         'profile_contact_info',
         \App\Models\AdminParmisiton::allowed(Auth::id(), 'profile_sensitive_info')
      );
      $canViewProfileEmail = \App\Models\AdminParmisiton::allowed(Auth::id(), 'profile_email_info', $legacyProfileContact);
      $canViewProfilePhone = \App\Models\AdminParmisiton::allowed(Auth::id(), 'profile_phone_info', $legacyProfileContact);
   ...
   <div class="col-sm-12 col-md-4 employee-cv">
      ...
      <div class="card-content">
         ...
         <div class="card-content-languages">
            ...
            @if($canViewProfileEmail || $canViewProfilePhone)
            <div class="card-content-languages-group">
               <table class="table table-hover" width="100%">
                  <caption class="resumecaption">Contact Information</caption>
                  <tbody>
                     @if($canViewProfileEmail)
                     <tr>
                        <th>Email</th>
                        <td>{{ $user->email ?: 'Not added' }}</td>
                     </tr>
                     @endif
                     @if($canViewProfilePhone)
                     <tr>
                        <th>Phone</th>
                        <td>{{ $profilePhone ?: 'Not added' }}</td>
                     </tr>
                     @endif
                  </tbody>
               </table>
...
@if($agency)
@php
$host_lists=DB::table('host_data')->join('users','users.id','host_data.user_id')->where('agency_code',$agency->code)->orderby('host_data.id','desc')->get();
@endphp
<div class="body-content">
		...
		<div class="col-xl-12 col-sm-12 py-2">
			<div class="card mb-4">
				...
				<div class="card-body">
					 ...
					 <table class="table display table-bordered table-striped table-hover basic profile-table-card">
			                    <thead>
			                      <tr>
			                       <th>Sl</th>
			                       <th>ID</th>
                     ...
                     $host_start_date = 2023-06-16;
                    	    ...
                    	    $totalDurationFormatted = $totalDuration->format('H:i:s');
			                    ...
			                    <tr>
			                      ...
			                      <td class="profile-nowrap">Day : {{$day_count}}<br>Time : {{$totalDurationFormatted}}</td>
					 ...
					 <table class="table display table-bordered table-striped table-hover basic profile-table-card">
			                 ...
			                 <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td class="profile-nowrap">{{$day_time_h->day_times}}</td>
			                      <td class="profile-nowrap">{{$day_time_h->live_time}}</td>
			                      <td class="profile-nowrap">@if($day_time_h->brd_type==2) Video @else Audio @endif</td>
			                  </tr>
			                  @endforeach
			              </tbody>
			              <tfoot>
					 ...
					 <table class="table display table-bordered table-striped table-hover basic profile-table-card">
			                 ...
			                 <tbody>
			                    ...
			                    <tr>
			                      ...
			                      <td class="profile-nowrap">{{$dayTimeHistory->day_times}}</td>
			                      <td class="profile-nowrap">{{$dayTimeHistory->live_time}}</td>
			                      <td class="profile-nowrap">@if($dayTimeHistory->brd_type==2) Video @else Audio @endif</td>
			                  </tr>
			                  @endforeach
			              </tbody>
			              <tfoot>
