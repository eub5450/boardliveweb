...
<head>
  ...
  <script src="{{asset('public/game/teenpatti/')}}/js/main_{{$fortunesetting->pusher_id}}.js"></script> 
        ...
        <div style="flex-direction: unset;flex-wrap: wrap;" class="container">
            ...
            <div class="topbodybar" style="width: 100%; align-items: start; padding: 2px;">
                <div class="row col-12" style="margin-left:  -2px;background:#ffffff5e;border-radius: 6px;"> 
                    <div class="col-4 text-center text-white" style=""><img src="https://broadlive.xyz/public/game/teenpatti/image/apple.png" alt="Saven Winner"></div> 
                    <div class="col-4 text-center text-white" style=""><img src="https://broadlive.xyz/public/game/teenpatti/image/lemon.png" alt="Saven Winner"></div> 
                    <div class="col-4 text-center text-white" style="">
                        <img src="https://broadlive.xyz/public/game/teenpatti/image/watermelon.png" alt="Saven Winner">
                    </div> 
                </div>
            </div>
