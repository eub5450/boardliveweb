        ...
        <div class="container gamemain" >
            ...
            <div class="footer">
                <div class="footer_top">
                    <button class="box_wrapper" disabled style="background-image:url(https://broadlive.xyz/public/game/new/image/appleboard.png);">
                    ...
                    <button class="box_wrapper" disabled style="background-image:url(https://broadlive.xyz/public/game/new/image/lemonboard.png);">
                    ...
                    <div class="footer_bottom_left">
                        <div class="footer_bottom_left_right">
                            <div class="footer_bottom_left_right_top d-none">
                                <input type="text" name="" id="speed" value="" readonly placeholder="{{ optional(Auth::user())->name ?? '' }}">
                            </div>
        ...
        <div style="flex-direction: unset;flex-wrap: wrap;" class="container">
            ...
            <div class="topbodybar" style="width: 100%; align-items: start; padding: 2px;">
                <div class="row col-12" style="margin-left:  -2px;background:#0000008c;border-radius: 6px;"> 
                    <div class="col-4 text-center text-white" style=""><img src="https://broadlive.xyz/public/game/new/image/apple.png" alt="Saven Winner"></div> 
                    <div class="col-4 text-center text-white" style=""><img src="https://broadlive.xyz/public/game/new/image/lemon.png" alt="Saven Winner"></div> 
                    <div class="col-4 text-center text-white" style="">
                        <img src="https://broadlive.xyz/public/game/new/image/watermelon.png" alt="Saven Winner">
                    </div> 
                </div>
            </div>
...
const settimeout_here = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/tray_id",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
...
const saven_win_get_winner = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/winner_saven_win",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const insert_bettingapple = (Amount, betting_to) => {
 //  console.log(Amount + 'insert_betting' + betting_to);
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/fortune_insert",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'amount' : Amount,
           'pot_no' : betting_to,
...
const robot = () => {
  // win_or_loss_calculation();
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/robot/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const win_lock_id = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/win_lock_id/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const insert_betting_watermellon = (Amount, betting_to) => {
 //  console.log(Amount + 'insert_betting' + betting_to);
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/fortune_watermelon_insert",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'amount' : Amount,
           'pot_no' : betting_to,
...
const get_users_amount = () => {
  // win_or_loss_calculation();
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/user?authkey=" + $('#authkey').val() + "&authtoken=" + $('#authtoken').val(),
       success:function(res){
           $('.Server_Issue').hide();
           if(res.st == true){
            $('#total_amount').val(res.balance);
...
const win_or_loss_calculation = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/win_or_loss_calculation/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const result_final = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/result_final/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const win_pred = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/win_pred/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const get_winner_info = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/get_winner_info/",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
           'topone': topone,
...
const get_fruits_results = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/betel/wining_fruits",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
       },
...
const input_online_or_oflline = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://broadlive.xyz/betel/fortune_user_activity",
        "data" : {
             tray_id: $('#tray_id').val(),
             'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const input_online_or_oflline_get_users = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://broadlive.xyz/betel/fortune_all_active_users",
        "data" : {},
        success:function(res){
...
const get_last_my_result = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://broadlive.xyz/betel/last_user_result",
        "data" : {
            'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
