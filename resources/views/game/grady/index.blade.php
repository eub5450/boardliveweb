...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/game/grady/')}}/css/style_v1.css">
...
.image-container img.fade {
   ...
   <body style="    overflow: hidden;background: url('https://broadlive.xyz/public/game/grady/image/magicpattern-polka-dot-pattern-1724481643290.png') ;    background-size: cover;" >
...
<!--<body style="background: url('https://images8.alphacoders.com/362/362134.jpg'); " >-->
    ...
    <!--<div class="laodingstart" style="    overflow: hidden;width: 100%; height: 100%; margin: 0; padding: 0; background: rgb(241,93,194);background: url('https://broadlive.xyz/public/game/grady/image/magicpattern-polka-dot-pattern-1724481643290.png') ;    background-size: cover;position: absolute; z-index: 100;">-->
    <!--    <img class="" style="    overflow: hidden;z-index: -1;border-radius: 0; border: none; width: 100%;position: absolute; top: 25%; left: 0;" src="{{asset('store/profile')}}/default.png" alt="">-->
    <!--</div>-->
        ...
        <div class="container">
            <div class="topbar mobilewidth ">
                ...
                <div class="image-container">
                    <img id="top_one" src="https://broadlive.xyz/store/profile/default.png" alt="Image 1">
                    <img id="top_two" src="https://broadlive.xyz/store/profile/default.png" alt="Image 2">
                    <img id="top_three" src="https://broadlive.xyz/store/profile/default.png" alt="Image 3">
                    <img id="top_four" src="https://broadlive.xyz/store/profile/default.png" alt="Image 4">
                    <img id="top_five" src="https://broadlive.xyz/store/profile/default.png" alt="Image 5">
                </div>
        ...
        <div class="container">
            ...
            <div class="container" style="background: #f7f7f700; border: none; box-shadow: none;">
                ...
                <div class="body gaming-effect">
                    <p class="titler">
                        <span id="emoji">ðŸŽ® Congratulations</span> to the following winner(s)
                    </p>
                    <div class="box_wrapper">
                        <div class="box_rr animate-winner">
                            ...
                            <li>
                                ...
                                <span class="info_r bet1">0</span>
                            </li>
                            <li>
                                <span class="info">Win: </span>
                                <span class="info_r betresult1">0</span>
                            </li>
                        </div>
                        <div class="box_rr animate-winner" style="animation-delay: 0.3s;">
                            ...
                            <li>
                                <span class="info">Bet: </span>
                                <span class="info_r bet2">0</span>
                            </li>
                            <li>
                                <span class="info">Win: </span>
                                <span class="info_r betresult2">0</span>
                            </li>
                        </div>
                        <div class="box_rr animate-winner" style="animation-delay: 0.6s;">
                            ...
                            <li>
                                <span class="info">Bet: </span>
                                <span class="info_r bet3">0</span>
                            </li>
                            <li>
                                <span class="info">Win: </span>
                                <span class="info_r betresult3">0</span>
                            </li>
                        </div>
                    </div>
                    <div class="my_wining_info animate-my-info">
                        ...
                        <div class="left">
                            <li>
                                <span class="info">Bet: </span>
                                <span class="info_r myBet">0</span>
                            </li>
                            <li>
                                <span class="info">Win: </span>
                                <span class="info_r myBetWin">0</span>
                            </li>
                        </div>
                    </div>
                </div>
...
const settimeout_here = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/tray_id",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
...
const saven_win_get_winner = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/winner_saven_win",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const robot = () => {
  // win_or_loss_calculation();
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/robot/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const account_list_users = () => {
    ...
    $.ajax({
        method: "get",
        url: "https://broadlive.xyz/grady/account_list_data",
        data: {
            authkey: $('#authkey').val(),
            authtoken: $('#authtoken').val(),
        },
...
const insert_betting_watermellon = (Amount, betting_to) => {
 //  console.log(Amount + 'insert_betting' + betting_to);
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/fortune_watermelon_insert",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'amount' : Amount,
           'pot_no' : betting_to,
...
const get_users_amount = () => {
  // win_or_loss_calculation();
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/user?authkey=" + $('#authkey').val() + "&authtoken=" + $('#authtoken').val(),
       success:function(res){
           $('.Server_Issue').hide();
           if(res.st == true){
               $('#total_amount').val(res.balance);
...
const win_or_loss_calculation = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/win_or_loss_calculation/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const result_final = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/result_final/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const win_pred = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/win_pred/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const get_winner_info = () => {
   // ajax
    $('.img1').attr('src',"https://broadlive.xyz/public/game/new/image/user.png");
    $('.username1').html('');
    $('.bet1').html('');
    $('.betresult1').html('');
    $('.img2').attr('src',"https://broadlive.xyz/public/game/new/image/user.png");
    $('.username2').html('');
    $('.bet2').html('');
    $('.betresult2').html('');
    $('.img3').attr('src',"https://broadlive.xyz/public/game/new/image/user.png");
    $('.username3').html('');
    $('.bet3').html('');
    $('.betresult3').html('');
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/get_winner_info/",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
       },
...
const get_fruits_results = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://broadlive.xyz/grady/wining_fruits",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
       },
...
$(document).ready(function () {
   ...
   // console.log(message);
    ...
    function sendAjaxRequest(betAmount, boxValue) {
        $.ajax({
            method: "get",
            url: "https://broadlive.xyz/grady/fortune_insert",
            data: {
                'authkey': $('#authkey').val(),
                'authtoken': $('#authtoken').val(),
                tray_id: $('#tray_id').val(),
...
const input_online_or_oflline = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://broadlive.xyz/grady/fortune_user_activity",
        "data" : {
             tray_id: $('#tray_id').val(),
             'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
        ...
        success:function(res){
          ...
          if (res.data[0]) {
            updateImageWithAnimation('#top_one', 'https://broadlive.xyz/' + res.data[0].profile);
            $('#top_one_name').text(res.data[0].name);
        }
        
        if (res.data[1]) {
            updateImageWithAnimation('#top_two', 'https://broadlive.xyz/' + res.data[1].profile);
            $('#top_two_name').text(res.data[1].name);
        }
        
        if (res.data[2]) {
            updateImageWithAnimation('#top_three', 'https://broadlive.xyz/' + res.data[2].profile);
            $('#top_three_name').text(res.data[2].name);
        }
        
        if (res.data[3]) {
            updateImageWithAnimation('#top_four', 'https://broadlive.xyz/' + res.data[3].profile);
            $('#top_four_name').text(res.data[3].name);
        }
        
        if (res.data[4]) {
            updateImageWithAnimation('#top_five', 'https://broadlive.xyz/' + res.data[4].profile);
...
const input_online_or_oflline_get_users = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://broadlive.xyz/grady/fortune_all_active_users",
        "data" : {},
        success:function(res){
            $('#hidden_info_here.users_here .users_box')
            const data = res.data.map((curE) => {
                  return '<div class="box_r"><img src="https://broadlive.xyz/'+  curE.profile +'" alt=""><p class="title">'+curE.name+'</p></div>';;
            });
...
const get_last_my_result = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://broadlive.xyz/grady/last_user_result",
        "data" : {
            'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
  ...
  if (curE.pot_no === "watermelon") {
    return `
      <div class="row col-12" style="margin-left: -2px; background: #ffffff5e; border-radius: 4px; border-radius: 5px; margin-bottom: 5px;">
        ...
        <div class="col-3 text-center text-white">
          <img src="https://broadlive.xyz/public/game/new/image/watermelon.png" alt="Saven Winner" style="width: 21px;">
        </div> 
    ...
    return `
      <div class="row col-12" style="margin-left: -2px; background: #ffffff5e; border-radius: 4px; border-radius: 5px; margin-bottom: 5px;">
        <div class="col-4 text-center text-white">${curE.tray_id}</div> 
        <div class="col-3 text-center text-white">
          <img src="https://broadlive.xyz/public/game/new/image/lemon.png" alt="Saven Winner" style="width: 21px;">
        </div>
        <div class="col-2 text-center text-white">
          ${result}
        </div> 
    ...
    return `
      <div class="row col-12" style="margin-left: -2px; background: #ffffff5e; border-radius: 4px; border-radius: 5px; margin-bottom: 5px;">
        <div class="col-4 text-center text-white">${curE.tray_id}</div> 
        <div class="col-3 text-center text-white">
          <img src="https://broadlive.xyz/public/game/new/image/apple.png" alt="Saven Winner" style="width: 21px;">
        </div> 
        <div class="col-2 text-center text-white">
          ${result}
        </div>
