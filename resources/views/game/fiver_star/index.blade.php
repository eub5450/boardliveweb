...
const settimeout_here = () => {
  //  let nowTime = Number(new Date().getTime()/1000);
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/tray_id",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
...
const saven_win_get_winner = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/winner_saven_win",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const insert_bettingapple = (Amount, betting_to) => {
 //  console.log(Amount + 'insert_betting' + betting_to);
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/fortune_insert",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'amount' : Amount,
           'pot_no' : betting_to,
...
const insert_betting_watermellon = (Amount, betting_to) => {
 //  console.log(Amount + 'insert_betting' + betting_to);
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/fortune_watermelon_insert",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'amount' : Amount,
           'pot_no' : betting_to,
...
const get_users_amount = () => {
  // win_or_loss_calculation();
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/user?authkey=" + $('#authkey').val() + "&authtoken=" + $('#authtoken').val(),
       success:function(res){
           $('.Server_Issue').hide();
           if(res.st == true){
...
const win_or_loss_calculation = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/win_or_loss_calculation/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const result_final = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/result_final/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const win_pred = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/win_pred/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const get_winner_info = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/get_winner_info/",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
       },
...
const get_fruits_results = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.site/fivestar/wining_fruits",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
       },
       success:function(res){
           ...
           const rewards = res.data.map((curE) => {
               if(curE.winner == "watermelon"){
                   return '<div class="row col-12" style="margin-left:  -2px;background:#ffffff5e;border-radius: 6px;"> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style=""><img src="https://bplive.site/public/game/fivestar/image/watermelon.png" alt="Saven Winner"></div> </div>';
               }else if(curE.winner == "saven_win"){
                   return '<div class="row col-12" style="margin-left: -2px;background:#ffffff5e;border-radius: 6px;"> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style=""><img src="https://bplive.site/public/game/fivestar/image/lemon.png" alt="Saven Winner"></div> <div class="col-4 text-center text-white" style="">-</div> </div>';
               }else{
                   return '<div class="row col-12" style="margin-left: -2px;background:#ffffff5e;border-radius: 6px;"> <div class="col-4 text-center text-white" style=""><img src="https://bplive.site/public/game/fivestar/image/apple.png" alt="Saven Winner"></div> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style="">-</div> </div>';
               }
           });
...
const input_online_or_oflline = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://bplive.site/fivestar/fortune_user_activity",
        "data" : {
             tray_id: $('#tray_id').val(),
             'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const input_online_or_oflline_get_users = () => {
    ...
    $.ajax({
        "method" : "get",
        "url" : "https://bplive.site/fivestar/fortune_all_active_users",
        "data" : {},
        success:function(res){
