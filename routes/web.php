...
Route::get('/lucky_star','SubmitFromController@LuckStar');
...
Route::get('betel/fruits','NewGameController@Index');
Route::get('betel/tray_id','NewGameController@TimeCall')->middleware('throttle:game_hit');;
Route::get('betel/fortune_insert','NewGameController@FortuneInsert')->middleware('throttle:game_hit');;
Route::get('betel/fortune_saven_insert','NewGameController@FortuneSevenInsert')->middleware('throttle:game_hit');;
Route::get('betel/fortune_watermelon_insert','NewGameController@FortunewatermelonInsert');
Route::get('betel/winner_saven_win','NewGameController@GameWinner');
Route::get('betel/win_pred','NewGameController@WinManpu')->middleware('throttle:game_hit');;
Route::get('betel/wining_fruits','NewGameController@LastGameWinner')->middleware('throttle:game_hit');;
Route::get('betel/get_winner_info','NewGameController@GameWinnerInfo');
Route::get('betel/user','NewGameController@UserData')->middleware('throttle:game_hit');;
Route::get('betel/result_final','NewGameController@Result_lock')->middleware('throttle:game_hit');;
Route::get('betel/push_user_data','NewGameController@PushUserData');
Route::get('betel/win_or_loss_calculation/','NewGameController@WinOrLoss')->middleware('throttle:game_hit');;
Route::get('betel/robot/','NewGameController@Robot');
Route::get('betel/last_user_result','NewGameController@UserResult');
//Route::get('betel/fruits','Game\FruitsGameController@Index');
Route::get('betel/pusher_cron_job','Game\FruitsGameController@pushercronjob');
// Route::get('betel/push_user_data','Game\FruitsGameController@winnning');
Route::get('betel/user_data','Game\FruitsGameController@userdata');
Route::get('betel/hit_pot','Game\FruitsGameController@HitPots');
Route::get('betel/all_active_user','Game\FruitsGameController@ActiveUser');
Route::get('betel/all_last_rank','Game\FruitsGameController@LastRank');
Route::get('betel/fortune_user_activity/','NewGameController@UserAvtivity');
Route::get('betel/fortune_all_active_users/','NewGameController@AllActiveUser');
...
Route::get('new_live/share/v3/{id}/{ChannalName}/{brd_type}','UserInLiveLink@NewLive');
Route::get('live/share/v1/{id}/{ChannalName}','UserInLiveLink@Live');
...
Route::get('admin-audio-brd-background','GiftFileController@AudioBrdBackgroundIndex')->name('audio-backgrounds.index');
...
Route::get('real_time_one', 'DashbordController@PusherOne');
Route::get('real_time_two', 'DashbordController@Pushertwo');
Route::get('admin-user-emailchange','UserController@UserEmailChange');
Route::get('setting/subadmin','SubAdminController@Index');
Route::get('setting/admin','SubAdminController@Index');
Route::get('setting/system-setting','ProtalController@PortalSetting');
Route::post('setting/subadmin-update','SubAdminController@Update');
Route::post('setting/admin-update','SubAdminController@Update');
...
Route::get('master-protal-recall-create','ProtalController@MasterProtalRecallCreate');
Route::get('master-protal-recall-user-search','ProtalController@MasterProtalRecallUserSearch');
Route::get('master-protal-recall','ProtalController@MasterProtalRecallHistory');
Route::get('master-protal-recall-history','ProtalController@MasterProtalRecallHistory');
Route::post('master_protal_recall_store','ProtalController@MasterProtalRecallStore');
...
Route::post('ban_id_reject/{id}','BanController@Reject');
//store
...
Route::post('effect_toggle/{id}','StoreController@ToggleShow');
Route::post('effect_delete/{id}','StoreController@Destroy');
//store
//profile
Route::get('id_search','ProfileController@Index');
Route::post('id_search_clear_device_ids/{id}','ProfileController@ClearDeviceIds');
...
Route::get('active_special_country_admin_frame_manual/{id}','ProfileController@CountryAdminFrameAtive');
...
Route::get('active_special_reseller_frame_manual/{id}','ProfileController@ResellerFrameAtive');
Route::get('inactive_special_country_admin_frame_manual/{id}','ProfileController@CountryAdminFrameInactive');
...
Route::get('inactive_special_reseller_frame_manual/{id}','ProfileController@ResellerFrameInactive');
...
Route::post('teenpati_third_setting','GameController@TeenPattiThirdBalanceSetting');
Route::post('fruits_game_commision','GameController@FruitsGameCommision');
Route::post('greedy_game_commision','GameController@GradyGameCommision');
Route::post('teenpatti_game_commision','GameController@TeenPattiGameCommision');
...
Route::get('admin/thomas-game-lobby','ThomasGameLobbyController@Index');
Route::post('admin/thomas-game-lobby/status','ThomasGameLobbyController@Update');
...
Route::get('gift_recall/{id}','ReCallController@GiftRecall');
...
//Route::post('support_replay/{id}','SupportController@Replay');
Route::get('admin-coin-generate','ConiGenerateController@Index');
Route::post('admin/coin-generate-store','ConiGenerateController@Store');
Route::get('generate_remove/{id}','ConiGenerateController@Delete');
});
...
if (file_exists(app_path('Http/Controllers/Author/ChatController.php'))) {
...
Route::get('country/author/host/toggle-type/{id}','HostController@ToggleHostingType')->name('author.host.toggle-type');
...
Route::get('country/author/protal/recall','ProtalController@RecallCreate')->name('country.author.protal-recall');
...
Route::get('sub_admin/comment_data','DashbordController@CommentUpdate')->name('subadmin.comment.data');
Route::get('sub_admin/chat_data','DashbordController@chat')->name('subadmin.chat.data');
...
require __DIR__.'/jambo_ai_routes.php';
