   ...
   public function Index(Request $request)
{
    ...
    // SLIDER
    // ----------------------------
    $slider = Slider::orderBy('id', 'desc')->get()->map(function ($item) {
        $copy = clone $item;
    ...
    public function HostType(Request $request)
{
    ...
    public function ProfileVisit(Request $request)
    {
        ...
        if (!User::where('id', $user_id)->exists() || !User::where('id', $receiver_id)->exists()) {
            return response()->json([[
                'message' => 'Invalid User',
                'code' => '404',
        ...
        return response()->json([[
            'message' => 'Profile Visit Stored Successfully',
