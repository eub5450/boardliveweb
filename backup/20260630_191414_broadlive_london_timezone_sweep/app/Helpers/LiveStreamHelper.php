...
{
    /**
     * Cache prefix kept removed intentionally.
     */
    ...
    /**
     * Clear host balance cache (cache removed)
     */
    public static function clearHostBalanceCache($host_id)
    {
        return true;
    }
    ...
    {
        $today = Carbon::now(config('app.timezone', 'Asia/Dhaka'))->toDateString();
    ...
    /**
     * Clear star level cache (cache removed)
     */
    public static function clearStarLevelCache($host_id)
    {
        return true;
    }
    ...
    public static function generateHostList($channelName, $host_id)
    {
        ...
        $host = [
            ...
            'balance' => self::getChannelGiftBalance($host_data->id, $channelName),
        ...
        foreach ($accept_list as $call) {
            ...
            $row = [
                ...
                'balance' => self::getChannelGiftBalance($co_host->id, $channelName),
    ...
    /**
     * Clear host list cache (cache removed)
     */
    public static function clearHostListCache($channelName, $host_id)
    {
        return true;
    }

    /**
     * Get channel gift balance without cache
     */
    public static function getChannelGiftBalance($user_id, $channelName)
    {
        return Gift::where('reciever_id', $user_id)
            ->where('channelName', $channelName)
            ->sum('value');
    }

    /**
     * Clear channel gift balance cache (cache removed)
     */
    public static function clearChannelGiftBalance($user_id, $channelName)
    {
        return true;
    }
    ...
    /**
     * Clear user ban cache (cache removed)
     */
    public static function clearUserBanCache($user_id)
    {
        return true;
    }
    ...
    /**
     * Clear user data cache (cache removed)
     */
    public static function clearUserDataCache($user_id, $host_id = null)
    {
        return true;
    }

    /**
     * Clear all caches for a host (cache removed)
     */
    public static function clearAllHostCaches($host_id, $channelName = null)
    {
        return true;
    }
}
