...
class ProtalController extends Controller
{
    ...
    public function PortalSetting()
    {
        ...
        $portalMinTransferAmount = (int) data_get($setting, 'portal_min_transfer_amount', 50000);
        if ($portalMinTransferAmount <= 0) {
            $portalMinTransferAmount = 50000;
        }

        return view('backend.protal.system_setting', compact('setting', 'portalMinTransferAmount'));
    }
