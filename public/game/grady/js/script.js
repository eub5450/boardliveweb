...
Echo.channel("users_amount_name").listen(".users_amount_event", i => {
    ...
    if (setTimeout(() => {
       ...
       // console.log(i.bord_name);
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(50).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" : i.bord_amount == "100000" ? f = "100k.png" :f = "500.png", $("#box_wrapper_bet_1").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header1").html(Number($("#saven_winner .container .footer .footer_top .box_wrapper .box_wrapper_header .header1").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%",
    ...
    } else if (i.bord_name == "lion") {
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(20).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" :i.bord_amount == "100000" ? f = "100k.png" :f = "500.png", $("#box_wrapper_bet_8").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header8").html(Number($("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header8").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%"
    ...
    }else if (i.bord_name == "cat") {
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(20).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" :i.bord_amount == "100000" ? f = "100k.png" :f = "500.png",$("#box_wrapper_bet_7").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header7").html(Number($("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header7").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%"
    ...
    }else if (i.bord_name == "tiger") {
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(20).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" :i.bord_amount == "100000" ? f = "100k.png" :f = "500.png",$("#box_wrapper_bet_6").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header6").html(Number($("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header6").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%"
    ...
    }else if (i.bord_name == "horse") {
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(20).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" :i.bord_amount == "100000" ? f = "100k.png" :f = "500.png",$("#box_wrapper_bet_5").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header5").html(Number($("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header5").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%"
    ...
    }else if (i.bord_name == "lemon") {
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(20).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" :i.bord_amount == "100000" ? f = "100k.png" :f = "500.png",$("#box_wrapper_bet_4").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header4").html(Number($("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header4").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%"
    ...
    }else if (i.bord_name == "banana") {
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(20).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" :i.bord_amount == "100000" ? f = "100k.png" :f = "500.png",$("#box_wrapper_bet_3").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header3").html(Number($("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header3").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%"
    ...
    }else if (i.bord_name == "grapes") {
        let _ = new Date().getTime();
        var r = Number(50).toFixed(0),
            a = Number(20).toFixed(0),
            f = "";
        i.bord_amount == "500" ? f = "500.png" : i.bord_amount == "1000" ? f = "1000.png" : i.bord_amount == "10000" ? f = "10k.png" : i.bord_amount == "50000" ? f = "50k.png" :i.bord_amount == "100000" ? f = "100k.png" :f = "500.png",$("#box_wrapper_bet_2").children(".all_batting_img_here").append('<img class="coin_box1" id="' + _ + '" src="' + ca + "/public/game/grady/image/" + f + '" alt="Saven Winner">'), $("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header2").html(Number($("#saven_winner .container .footer .mobilewidth .footer_top .box_wrapper .box_wrapper_header .header2").html()) + Number(i.bord_amount)), setTimeout(() => {
            $("#" + _).css({
                animation: "none",
                top: "" + r + "%",
                left: "" + a + "%"
