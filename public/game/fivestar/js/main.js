...
const settimeout_here = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/tray_id",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
                  ...
                  // console.log(data)
                   ...
                   $('#tray_id').val(data);
                    ...
                    if(time > 0 && time < 11){
                        ...
                        $('.clock_time_count_down').html(time);
                    }
                   if(time == 25){
                        //get_winner_info();
                       //win_or_loss_calculation();
...
const saven_win_get_winner = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/winner_saven_win",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const insert_betting = (Amount, betting_to) => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/fortune_insert",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'amount' : Amount,
           'pot_no' : betting_to,
...
const get_users_amount = () => {
  // win_or_loss_calculation();
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/user?authkey=" + $('#authkey').val() + "&authtoken=" + $('#authtoken').val(),
       success:function(res){
           $('.Server_Issue').hide();
           if(res.st == true){
...
//      $.ajax({
//          "method" : "get",
//          "url" : "http://localhost/fivestar/fivestar/win_predict/",
//          "data" : {},
//          success:function(res){
//          }
//      });
...
const win_or_loss_calculation = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/win_or_loss_calculation/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const win_pred = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/win_pred/",
       "data" : {
           'tray_id' : $('#tray_id').val(),
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
...
const get_winner_info = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/get_winner_info/",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
       },
       success:function(res){ 
           ...
           if(res.users_1st_amount != ""){
               $('.Winner_Here .box_wrapper .box_r .img1').attr('src', "https://bplive.app/public/game/new/image/user.png");
           ...
           if(res.users_2nd_amount != ""){
               $('.Winner_Here .box_wrapper .box_r .img2').attr('src',"https://bplive.app/public/game/new/image/user.png");
           ...
           if(res.users_3rd_amount != ""){
               $('.Winner_Here .box_wrapper .box_r .img3').attr('src',"https://bplive.app/public/game/new/image/user.png");
...
const get_fruits_results = () => {
   ...
   $.ajax({
       "method" : "get",
       "url" : "https://bplive.app/fivestar/wining_fruits",
       "data" : {
           'authkey': $('#authkey').val(),
           'authtoken': $('#authtoken').val(),
       },
       success:function(res){
           ...
           const rewards = res.data.map((curE) => {
               if(curE.winner == "watermelon"){
                   return '<div class="row col-12" style="margin-left:  -2px;background:#ffffff5e;border-radius: 6px;"> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style=""><img src="https://bplive.app/public/game/fivestar/image/watermelon.png" alt="Saven Winner"></div> </div>';
               }else if(curE.winner == "saven_win"){
                   return '<div class="row col-12" style="margin-left: -2px;background:#ffffff5e;border-radius: 6px;"> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style=""><img src="https://bplive.app/public/game/fivestar/image/lemon.png" alt="Saven Winner"></div> <div class="col-4 text-center text-white" style="">-</div> </div>';
               }else{
                   return '<div class="row col-12" style="margin-left: -2px;background:#ffffff5e;border-radius: 6px;"> <div class="col-4 text-center text-white" style=""><img src="https://bplive.app/public/game/fivestar/image/apple.png" alt="Saven Winner"></div> <div class="col-4 text-center text-white" style="">-</div> <div class="col-4 text-center text-white" style="">-</div> </div>';
               }
           });
